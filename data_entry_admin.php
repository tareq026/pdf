...
if(isset($_POST['btn_submit_admin'])){
    ...
    $data = new Pdf();
    $message = $data->savePersonnelInfoAdmin();
            ...
            <form class="form"  method="POST" action="" enctype="multipart/form-data" data-toggle="validator"
                ...
                <div class=" row">
                    <div class=" form-group col-md-8">
                        <label>1. Name</label>
                        <input  type="text" required class="form-control" id="full_name" name="full_name" placeholder="Enter your Full Name">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="col-md-4">
                        <label>Upload Image</label>
                        <input type="file"  class="form-control" name="upload_image"  placeholder="Upload Image">
                    </div>
                </div>
                <div class=" row">
                    <div class=" form-group col-md-4">
                        <label>2. Rank</label>
                        <input  type="text" required class="form-control" id="rank" name="rank" placeholder="Rank" >
                        <h6>Update Rank if neccessary.</h6>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class=" form-group col-md-4">
                        <label>3. BD/No</label>
                        <input  type="number" required class="form-control" id="bd_no" name="bd_no" placeholder="BD/No" >
                    </div>
                    <div class="form-group col-md-4">
                        <label>4. Branch/Trade</label>
                        <input  type="text" required class="form-control" id="br_trade"  name="br_trade" placeholder="Branch/Trade" >
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                ...
                <div class=" row">
                    ...
                    <div class=" form-group col-md-4">
                        ...
                        <input  type="date" required class="form-control" id="datepicker" name="date_of_birth" placeholder="Date_Of_Birth" >
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="col-md-4">
                ...
                <div  class="table-responsive">
                    ...
                    <table class="table table-bordered" id="new_mobile_num" style="margin-bottom: 5px">
                        ...
                        <tr>
                            <td style="background-color: white" contenteditable="true" class="ser_no_mobile"></td>
                ...
                <div class="form-group row">
                    <div class="col-md-offset-5 col-md-7">
                        <button type="submit" class="btn btn-success" id="save" name="btn_submit_admin">Submit</button>
                    </div>
                </div>
            </form>
        </div>
