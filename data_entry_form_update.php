...
$pdf = new Pdf();
    ...
    if (isset($_POST['btn_update'])) {
        $message = $pdf->updateDataEntryForm($_POST);
...
$mobileSql= "SELECT  * FROM per_mobile_num WHERE user_id='$user_id'&&data_entry_id='$data_entry_id'";
    ...
    <nav class="navbar navbar-default">
        <div class="container" >
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="view_data_entry_form.php">Homepage</a>
            </div>
        ...
        <div class="well">
            ...
            <form class="form" method="POST" action="" enctype="multipart/form-data" data-toggle="validator"
                ...
                <div class=" row">
                    ...
                    <div class=" form-group col-md-4">
                        <label>3. BD/No</label>
                        <input type="number" required  value="<?php echo $personnel_info['bd_no']; ?>" class="form-control" id="bd_no" name="bd_no" placeholder="BD/No">
                    </div>
                    <div class=" form-group col-md-4">
